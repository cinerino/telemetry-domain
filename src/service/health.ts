 ...
 */
export function checkGMONotification(_: {
    project: { id: string };
    notification: IGMOResultNotification;
}) {
    return async (__: {
    }) => {
        ...
        //     (doc) => <factory.action.trade.pay.IAction<factory.paymentMethodType.CreditCard>>doc.toObject())
        // );
